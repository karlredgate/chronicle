...
module.exports = function ( request, response ) {
    ...
    var gather = this.chronicle.gather;

    gather.prepare.call( response );

    var ok           = this.chronicle.responder.ok.bind(response);
    var not_found    = this.chronicle.responder.not_found.bind(response);
    var server_error = this.chronicle.responder.server_error.bind(response);
