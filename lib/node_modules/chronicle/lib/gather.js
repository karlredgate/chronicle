...
/** @brief Prepare a response object for chronicle use
 ...
 * response.error = [];
 * var pid = spawn( ... );
 * pid.stdout.on( 'data', this.chronicle.gather.output.bind(response) );
 * pid.stderr.on( 'data', this.chronicle.gather.error.bind(response) );
 */
